...
const Services = () => {
	return (
		<div className="container">
			<h1>Services</h1>
			<p>
				Abraham Lim specializes and handles cases which involves US
				Immigration law. This includes:
			</p>

			<ul className="list-group services">
				<li className="list-group-item">EB -5 INVESTMENT VISA</li>
				<li className="list-group-item">EB-2 PERM</li>
				<li className="list-group-item">LABOR CERTIFICATIONS</li>
				...
				<li className="list-group-item">MARRIAGE & FAMILY CASES</li>
				<li className="list-group-item">BATTERED SPOUSE CASES</li>
				<li className="list-group-item">DEPORTATION DEFENSE</li>
				<li className="list-group-item">CRIMINAL DEPORTATION</li>
				<li className="list-group-item">
			...
			<ul className="list-group services">
				<li className="list-group-item">crisis management</li>
